## 14 - PHP Optimizations

### Commands

- `,n` - Insert use statement
- `,nf` - Expand namespace
- `selection + :sort` - Sort selection by alphabetical order, can be used for namespaces
- `selection + ,su` - Sort selection from shorted to longest, can be used for namespaces
