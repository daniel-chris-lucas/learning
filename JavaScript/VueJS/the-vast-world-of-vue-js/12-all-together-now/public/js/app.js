...
},{"./views/checkout":79,"vue":74,"vue-resource":3}],77:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        validate: function validate() {
            this.$http.get('/api/coupons/' + this.coupon.code).success(function (coupon) {
                this.coupon = coupon;
                this.valid = true;
...
},{"./coupon.template.html":78}],78:[function(require,module,exports){
module.exports = '<input type="text"\n       name="coupon"\n       id="coupon",\n       class="form-control"\n       v-model="coupon.code"\n       v-on="blur: validate"\n       v-attr="readonly: valid">\n\n<p class="label label-primary" v-text="coupon.description"></p>';
...
},{"../components/Coupon":77,"./checkout.template.html":80}],80:[function(require,module,exports){
module.exports = '<h1>\n    Shirt Checkout\n    <small v-text="cost | coupon | currency"></small>\n</h1>\n\n<form>\n    <div class="form-group">\n        <label for="name">Name:</label>\n        <input type="text" name="name" id="name" class="form-control">\n    </div>\n\n    <div class="form-group">\n        <label for="email">Email:</label>\n        <input type="text" name="email" id="email" class="form-control">\n    </div>\n\n    <div class="form-group">\n        <label for="coupon">Coupon:</label>\n        <coupon when-applied="{{ applyDiscount }}"></coupon>\n    </div>\n</form>';
},{}]},{},[76]);
